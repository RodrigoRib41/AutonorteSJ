      ...
      <main>
        <section className="relative overflow-hidden border-b border-zinc-950/15 bg-[#f2c400]">
          ...
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
            ...
            <div className="relative mt-8 inline-flex rounded-full border border-zinc-950/20 bg-white/88 px-4 py-2 text-sm font-medium text-zinc-900 shadow-sm">
              {hasFilters
              ...
              <Button
                ...
                className={
                  filters.condition === "ZERO_KM"
                    ? "h-12 rounded-full bg-zinc-950 px-6 text-[#f2c400] hover:bg-zinc-900"
                    : "h-12 rounded-full border-zinc-950/25 bg-white/88 px-6 text-zinc-950 hover:bg-white"
                }
              >
        ...
        <section className="bg-[#f5f1df] py-16 sm:py-20">
