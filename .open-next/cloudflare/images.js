...
var define_IMAGES_DEVICE_SIZES_default = [360, 414, 640, 768, 1024, 1280, 1600, 1920];

// <define:__IMAGES_FORMATS__>
var define_IMAGES_FORMATS_default = ["image/webp"];

// <define:__IMAGES_IMAGE_SIZES__>
var define_IMAGES_IMAGE_SIZES_default = [80, 160, 240, 320, 480];
...
var define_IMAGES_QUALITIES_default = [75, 85, 95];

// <define:__IMAGES_REMOTE_PATTERNS__>
var define_IMAGES_REMOTE_PATTERNS_default = [{ protocol: "https", hostname: "^(?:^(?:res\\.cloudinary\\.com)$)$", port: "", pathname: "^(?:\\/(?!\\.{1,2}(?:\\/|$))(?:(?:(?!(?:^|\\/)\\.{1,2}(?:\\/|$)).)*?))$", search: "" }];
