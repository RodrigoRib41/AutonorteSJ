...
export function BrandLogo({ className, href }: BrandLogoProps) {
  const logo = (
    <div
      className={cn(
        "relative flex items-center justify-center overflow-hidden rounded-[1.35rem] border border-black/15 bg-[#f2c400] p-5 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.2)] sm:p-6",
        className
      )}
    >
      ...
      <div className="relative text-center">
        <div className="mx-auto mb-4 flex size-14 items-center justify-center rounded-[1.1rem] bg-zinc-950 text-xl font-semibold tracking-tight text-[#f2c400] shadow-[0_12px_28px_rgba(0,0,0,0.24)] sm:size-16 sm:rounded-[1.25rem] sm:text-2xl">
          TA
        </div>
